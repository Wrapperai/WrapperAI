...
$(document).ready(function () {
		...
		if (heroSliderExists) {
			...
			while (n < numberOfHeroSlides + 1) {
				...
				if (phase2FirstLoad[n].length) {
					gsap.timeline()
						.fromTo(phase2FirstLoad[n], { opacity: 0, xPercent: 20 }, {
							opacity: 1, xPercent: 0, duration: 0.4, stagger: {
								amount: 0.25,
								from: "end",
								grid: "auto"
							}, delay: phaseTwoDelay
				...
				if (phase2Regular[n].length) {
					gsap.timeline()
						.fromTo(phase2Regular[n], { opacity: 0, xPercent: 20 }, {
							opacity: 1, xPercent: 0, duration: 0.4, stagger: {
								amount: 0.25,
								from: "end",
								grid: "auto"
	...
	if (heroSliderNavUI.length) {
		...
		gsap.timeline()
			.fromTo(heroSliderNavUI, { opacity: 0 }, {
				opacity: 0.5, duration: 0.3, stagger: {
					amount: 0.25,
					from: "end",
					grid: "auto"
				}, delay: theDelay
	...
	if (heroSliderNavDots.length) {
		...
		gsap.timeline()
			.fromTo(heroSliderNavDots, { opacity: 0 }, {
				opacity: 1, duration: 0.3, stagger: {
					amount: 0.25,
					from: "end",
					grid: "auto"
				}, delay: theDelay
